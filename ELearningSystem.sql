...
create Table Videos(
    ...
    CONSTRAINT teacher_fk Foreign Key (teacherID) References Teacher(teacherID) ON DELETE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = latin1;
...
create Table PDFs(
    ...
    CONSTRAINT course_fk1 Foreign Key (course_ID) References Courses(course_ID) ON DELETE CASCADE,
    CONSTRAINT teacher_fk1 Foreign Key (teacherID) References Teacher(teacherID) ON DELETE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = latin1;
