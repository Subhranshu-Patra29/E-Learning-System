...
public class LoadingScreen extends JFrame{
    ...
    public LoadingScreen(){
        ...
        upperPic.setBounds(480, 90, 360, 343);
        ...
        loadingLbl.setForeground(Color.BLACK);
        loadingLbl.setBounds(75, 630, 250, 30);
        ...
        percentageLbl.setForeground(Color.BLACK);
        ...
        textLbl.setBounds(215, 420, 850, 80);
        mainPanel.add(textLbl);
        
        backgroundPic = new JLabel();
        backgroundPic.setIcon(new ImageIcon(ClassLoader.getSystemResource("javasemesterproject/icons/background2.png")));
        backgroundPic.setBounds(73, 0, 1200, 650);
