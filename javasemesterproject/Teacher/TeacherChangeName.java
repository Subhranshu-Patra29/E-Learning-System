...
public class TeacherChangeName extends JFrame implements ActionListener {
    ...
    public TeacherChangeName() {
        ...
        // Icon (Image)
        ImageIcon icon = new ImageIcon(ClassLoader.getSystemResource("javasemesterproject/icons/rename.png"));
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == updateNameButton) {
            ...
            try {
                ...
                String query = "UPDATE Teacher SET fname = '" + firstName + "', lname = '" + lastName + "' WHERE teacherID = '" + TeacherLogin2.currentTeacherID + "'";
