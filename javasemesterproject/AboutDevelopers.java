...
public class AboutDevelopers extends JFrame{
    ...
    public AboutDevelopers() {
        ...
        String[][] rowData = {{"8249945966", "Subhranshu Patra", "<html>Modules Development<html>"}, 
                               {"8088168180", "Nilmani Tiwari", "<html>Modules Integration<br/> and Code Refinement</html>"}, 
                               {"9905148911", "Rishu", "<html>Database Connectity<br/> and Design</html>"}};
