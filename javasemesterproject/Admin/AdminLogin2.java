...
public class AdminLogin2 extends JFrame {
    ...
    private void initComponents() {
        ...
        StudentImage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javasemesterproject/icons/admin.png"))); // NOI18N
        ...
        StudentLoginText.setText("Admin Login");
    ...
    private void loginBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginBtnActionPerformed
        ...
        if ("".equals(usernameInput.getText())) {
            ...
            System.out.println(name + " " + psswrdEntered);
        }

        try {
            DBConnection c1 = new DBConnection();
            String q = "select * from Admin where username='" + name + "' and password='" + psswrdEntered + "'";
