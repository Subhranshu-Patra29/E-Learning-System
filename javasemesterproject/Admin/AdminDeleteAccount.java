...
public class AdminDeleteAccount {
    ...
    /**
     * Deletes the admin account from the database.
     */
    private void deleteAccount() {
        try {
            DBConnection dbConnection = new DBConnection();
            String query = "DELETE FROM Admin WHERE Adminid = '" + AdminLogin2.currentAdminID + "'";
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(AdminDeleteAccount::new);
    }
}
